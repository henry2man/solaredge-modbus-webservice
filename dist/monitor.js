...
const MONITOR_PORT = process_1.default.env.PORT !== undefined ? parseInt(process_1.default.env.PORT, 0) : 8080;
const MONITOR_HOST = process_1.default.env.HOST || "0.0.0.0";
const MONITOR_API_KEY = process_1.default.env.API_KEY || "";
const MONITOR_TCP_HOST = process_1.default.env.TCP_HOST || "";
const MONITOR_TCP_PORT = process_1.default.env.TCP_PORT || "502";
